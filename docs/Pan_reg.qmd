...
### [Application to Traffic Deaths](#Application to traffic deaths )
...
# Panel Data {#panel-data-1 .centered background-color="#314f4f"}
...
## Notations for Panel Data {.centered background-color="#314f4f"}
...
## Why are panel data useful? {.centered background-color="#314f4f"}
...
## Example of a panel data set {.centered background-color="#314f4f"}
...
## An overview of data {.centered background-color="#314f4f"} {.scrollable}
...
## U.S traffic death data for 1982 {.centered background-color="#314f4f"}
...
## U.S traffic death data for 1988 {.centered background-color="#314f4f"}
...
## Regression line {.centered background-color="#314f4f"}
...
## Why might there be higher more traffic deaths in states that have higher alcohol taxes? {.centered background-color="#314f4f"}
...
## These omitted variables could cause omitted variable bias {.centered background-color="#314f4f"}
...
## Cultural attitude towards driving and drinking {.centered background-color="#314f4f"}
...
## Panel Data with Two Time Periods {.centered background-color="#314f4f"}
...
## Fixed Effects Regression {.centered background-color="#314f4f"}
...
## Regression equation for three states {.centered background-color="#314f4f"}
...
## The Fixed Effects Regression Model {.centered background-color="#314f4f"}
...
## Summary: Two ways to write the fixed effects model "n-1 binary regressor" form {.centered background-color="#314f4f"}
...
## Fixed Effects Regression: Estimation {.centered background-color="#314f4f"}
...
## 1. "n-1 binary regressors" OLS regression {.centered background-color="#314f4f"}
...
## 2. "Entity-demeaned" OLS regression {.centered background-color="#314f4f"}
...
# Application to traffic deaths {.centered background-color="#314f4f"}

## Panel Data for two years {.centered background-color="#314f4f"}
...
## compute mean fatality rate over all states for all time periods {.centered background-color="#314f4f"}
...
## Demeaned Regressioin {.centered background-color="#314f4f"}
...
## Use plm {.centered background-color="#314f4f"}
...
## Regression with Time Fixed Effect {.centered background-color="#314f4f"}
...
## Via plm {.centered background-color="#314f4f"}
...
## The Fixed Effects Regression Assumptions {.centered background-color="#314f4f"}
...
## estimate all seven models {.centered background-color="#314f4f"}
...
# [Wage data Woolridge book](https://tyleransom.github.io/teaching/MetricsLabs/lab15.html){.centered background-color="#314f4f"}
...
## Load the data {.centered background-color="#314f4f"}
...
## Summary Statistics with Panel Data {.centered background-color="#314f4f"}
...
## Pooled OLS, Random Effects, and Fixed Effects Models {.centered background-color="#314f4f"}

$\begin{align*} \log(wage_{it}) & = \beta_0 + \beta_1 educ_{i} + \beta_2 black_{i} + \beta_3 hisp_{i} + \beta_4 exper_{it} + \beta_5 exper_{it}^2 +\\ &\phantom{=\,\,} \beta_6 married_{it} + \beta_7 union_{it} + \beta_8 rur_{it} + \sum_t \beta_{9,t}year_{it} + a_i + u_{it} \end{align*}$ The pooled ols by `lm_robust`
...
## Random effects {.centered background-color="#314f4f"}
...
## Fixed effects {.centered background-color="#314f4f"}
...
## Clustered standard errors the most appropriate standard errors account for within-person serial correlation and are robust to heteroskedasticity. {.centered background-color="#314f4f"} 
